...
public static class QuestionDifficultyExtension
{
    ...
    /// <summary>
    /// Determines the <see cref="QuestionDifficulty"/> category corresponding to a given matrix score.
    /// </summary>
    /// <param name="matrix">The matrix score to evaluate.</param>
    /// <returns>The <see cref="QuestionDifficulty"/> category that matches the specified matrix value.</returns>
